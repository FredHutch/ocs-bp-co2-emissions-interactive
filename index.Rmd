...
Taking the `data_long` object, and using only data from the US, calculate the first and last year that a value was reported for each Label (e.g. CO2 emissions, energy use, etc). 
