...
quiz(caption = "",
  ...
  question("Which of the following does the `mutate()` function in the `dplyr` package help us do? (more than one correct answer)",
    ...
    answer("Rename a variable.", message = "While we could use `mutate` to rename a variable using multiple steps (create a new variable based on the an existing variable and then remove the old variable), renaming a variable is more efficient with the `rename()` function."),
...
6. Check your data by looking at `new.mtcars` 
